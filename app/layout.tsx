            ...
            <head>
                ...
                */}
                ...
                {/*
                  ...
                  The media="print" swap is done by the inline script below
                  rather than an onLoad attribute, because React does not
                  support string event handlers. Writing onLoad="this.media='all'"
                  in JSX does not throw -- React silently DROPS the attribute --
                  so the stylesheets stayed media="print" forever and none of
                  these four families ever loaded. The page rendered in fallback
                  system fonts, on every route, and nothing reported an error.
                  TypeScript caught it; the HTTP crawler could not.

                  Keep the script and the links together: the script attaches
                ...
                */}
                ...
                <script
                    dangerouslySetInnerHTML={{
                        __html:
                            "(function(){var l=document.querySelectorAll('link[data-font-swap]');" +
                            "for(var i=0;i<l.length;i++){(function(k){" +
                            // Already finished loading before this ran.
                            "if(k.sheet){k.media='all';return}" +
                            "k.addEventListener('load',function(){k.media='all'},{once:true})" +
                            "})(l[i])}})();",
                    }}
                />
                <noscript>
