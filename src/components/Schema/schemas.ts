 ...
 */
export const getPersonSchema = (person: CmsData = {}) => ({
    "@context": "https://schema.org",
    "@type": "Person",
 ...
 */
export const getAggregateRatingSchema = (rating: CmsData = {}) => ({
    "@context": "https://schema.org",
    "@type": "EducationalOrganization",
    "name": "Global Professional Certifications",
    "aggregateRating": {
 ...
 */
export const getContactPageSchema = (page: CmsData = {}) => ({
    "@context": "https://schema.org",
    "@type": "ContactPage",
 ...
 */
export const getLocalBusinessSchema = (business: CmsData = {}) => ({
    "@context": "https://schema.org",
    "@type": "EducationalOrganization",
 ...
 * @param {Object} page - Optional page details
 */
export const getAboutPageSchema = (page: CmsData = {}) => ({
    "@context": "https://schema.org",
    "@type": "AboutPage",
 ...
 */
export const getSoftwareApplicationSchema = (software: CmsData = {}) => ({
    "@context": "https://schema.org",
