...
export default function MediaSlider({
    ...
    const [fullscreenSrc, setFullscreenSrc] = useState<CmsData>(null);
...
function ImageTile({ src, isCenter, width, height }: ComponentProps) {
    return (
...
function VideoTile({ src, isCenter, width, height }: ComponentProps) {
    const vidRef = useRef<CmsData>(null);
