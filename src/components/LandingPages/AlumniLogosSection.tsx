...
// 1. PwC
const PwcLogo = ({ className = "h-8 w-auto" }: ComponentProps) => (
...
// 2. Ernst & Young (EY)
const EyLogo = ({ className = "h-8 w-auto" }: ComponentProps) => (
...
// 3. Deloitte
const DeloitteLogo = ({ className = "h-7 w-auto" }: ComponentProps) => (
...
// 4. KPMG
const KpmgLogo = ({ className = "h-8 w-auto" }: ComponentProps) => (
...
// 5. Wells Fargo
const WellsFargoLogo = ({ className = "h-8 w-auto" }: ComponentProps) => (
...
const StandardCharteredLogo = ({ className = "h-8 w-auto" }: ComponentProps) => (
...
// 7. Citibank (Citi)
const CitibankLogo = ({ className = "h-8 w-auto" }: ComponentProps) => (
...
// 8. Ford Motor
const FordLogo = ({ className = "h-8 w-auto" }: ComponentProps) => (
...
const RelianceLogo = ({ className = "h-8 w-auto" }: ComponentProps) => (
...
// 10. Grant Thornton
const GrantThorntonLogo = ({ className = "h-8 w-auto" }: ComponentProps) => (
