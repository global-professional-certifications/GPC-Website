 ...
 */
export const extractHeadings = (body: CmsData = [], depth = 'h2h3') => {
...
const FAQItem = ({ question, answer }: ComponentProps) => {
...
const TableOfContentsBlock = ({ value, body }: ComponentProps) => {
...
const PortableTextRenderer = ({ value }: ComponentProps) => {
  ...
  return <PortableText value={value} components={components as CmsData} />
}
