    ...
    <section className="px-6 md:px-12 lg:px-20 py-16 bg-gray-50">
      <div className="container mx-auto text-center">
        ...
        <h2 className="text-2xl md:text-4xl font-bold text-gray-900">
          Why Global Professional Certifications
        </h2>
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="w-16 h-16 flex items-center justify-center rounded-full bg-white shadow-sm">
              <FaGlobe className="text-brand-blue text-2xl" />
            </div>
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="w-16 h-16 flex items-center justify-center rounded-full bg-white shadow-sm">
              <FaUserCheck className="text-brand-blue text-2xl" />
            </div>
            <h3 className="text-lg font-semibold text-gray-900">
              One-on-one Support
            </h3>
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="w-16 h-16 flex items-center justify-center rounded-full bg-white shadow-sm">
              <FaChalkboardTeacher className="text-brand-blue text-2xl" />
            </div>
            <h3 className="text-lg font-semibold text-gray-900">
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="w-16 h-16 flex items-center justify-center rounded-full bg-white shadow-sm">
              <FaClock className="text-brand-blue text-2xl" />
            </div>
            <h3 className="text-lg font-semibold text-gray-900">
