...
const FAQDisplay = lazy(() => import("../FAQDisplay"));
...
const MentorShowcase = lazy(() => import("../About/MentorShowcase"));
...
const AnniversaryVideo = () => {
  ...
  const frameRef = useRef<CmsData>(null);
...
const Counter = ({ target }: ComponentProps) => {
