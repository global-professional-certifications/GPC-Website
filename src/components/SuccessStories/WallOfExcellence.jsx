...
const WallOfExcellence = ({ wallEntries, stories }) => {
    ...
    const ITEMS_PER_PAGE = 18; // 3 rows of 6 cards
                        ...
                        {displayStories.length > 0 ? (
                            pagedStories.map((story, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex flex-col items-center text-center bg-white rounded-[28px] p-3 pt-[72px] shadow-sm border border-gray-100/60 hover:shadow-2xl hover:shadow-brand-blue/10 transition-all duration-500 group h-full">
                                            ...
                                            <h4 className="w-full text-center text-[15px] md:text-[16px] font-bold text-gray-900 mb-3">
                                                {story.name}
                                            </h4>
                                            ...
                                            <div className="flex-1 flex flex-col items-center justify-center w-full mb-4">
                                                ...
                                                {story.company && (
                                                    <p className="font-poppins text-[12px] text-gray-700 my-2 text-center">
                                                        {story.company}
                                                    </p>
                                                )}
                                                ...
                                                {/* Designation */}
                                                {role && (
                                                    <span className="font-poppins text-[10px] md:text-[12px] text-gray-500 text-center">
                                                        {role}
                                                    </span>
                                                )}
                                            </div>
