...
const CustomPrevArrow = ({ onClick }: ComponentProps) => (
    <button
        onClick={onClick}
...
const CustomNextArrow = ({ onClick }: ComponentProps) => (
    <button
        onClick={onClick}
...
export default function EventCarousel({ images, eventName }: ComponentProps) {
                        ...
                        {images.map((image, index) => (
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    if (slider) {
                                        // react-slick attaches its instance to the DOM node; not in the Element type.
                                        (slider as CmsData).slick?.slickGoTo(index);
                                    }
                                }}
